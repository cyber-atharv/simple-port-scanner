 ...
 * ============================================================================
 *  Demonstrates asynchronous event-driven TCP socket scanning using Boost.Asio.
 *  Uses non-blocking connections to scan large port ranges quickly with low overhead.
 * ============================================================================
 */
